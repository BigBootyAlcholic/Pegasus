...
#pragma pack(pop)
	...
	public:
		...
		{
			return Caller::Call<bool>(Patterns::Vars::g_WriteBoolToBitBuffer, this, boolean, 1);
			//return big::g_pointers->m_gta.m_write_bitbuf_bool(this, boolean, 1);
		}
		bool ReadBool(bool* boolean)
		{
			return Caller::Call<bool>(Patterns::Vars::g_ReadBoolFromBitBuffer, this, boolean, 1);
		...
		{
			return Caller::Call<bool>(Patterns::Vars::g_ReadStringFromBitBuffer, this, string, bits);
			//return big::g_pointers->m_gta.m_read_bitbuf_string(this, string, bits);
		}
		bool WriteByte(uint8_t integer, int bits)
		{
			return Caller::Call<bool>(Patterns::Vars::g_WriteDwordToBitBuffer, this, integer, bits);
		...
		bool ReadByte(uint8_t* integer, int bits)
		{
			...
			if (Caller::Call<bool>(Patterns::Vars::g_ReadDwordFromBitBuffer, this, &read, bits))
			{
				*integer = read;
				return true;
			}
		...
		bool ReadDword(uint32_t* integer, int bits)
		{
			...
			return Caller::Call<bool>(Patterns::Vars::g_ReadDwordFromBitBuffer, this, integer, bits);
		}
		bool WriteInt32(int32_t integer, int bits)
		{
			//return big::g_pointers->m_gta.m_write_bitbuf_int32(this, integer, bits);
			return Caller::Call<bool>(Patterns::Vars::g_WriteInt32ToBitBuffer, this, integer, bits);
		}
		...
		bool WriteQWord(uint64_t integer, int bits)
		{
			...
			return Caller::Call<bool>(Patterns::Vars::g_WriteQWordToBitBuffer, this, integer, bits);
		}
		...
		bool WriteInt64(int64_t integer, int bits)
		{
			...
			return Caller::Call<bool>(Patterns::Vars::g_WriteInt64ToBitBuffer, this, integer, bits);
		}
		...
		bool WriteArray(void* array, int size)
		{
			...
			return Caller::Call<bool>(Patterns::Vars::g_WriteArrayToBitBuffer, this, array, size, 0);
		}
		...
		bool ReadArray(PVOID array, int size)
		{
			...
			return Caller::Call<bool>(Patterns::Vars::g_ReadArrayFromBitBuffer, this, array, size, 0);
		}
