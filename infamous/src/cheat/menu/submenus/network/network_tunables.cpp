...
void NetworkTunablesMenu::Update() {
	...
	if (m_Vars.m_DisableIdleKick) {
		...
		*Menu::Global(262145).At(8420).As<int*>() = 30000;
		*Menu::Global(262145).At(8421).As<int*>() = 60000;
		*Menu::Global(262145).At(8422).As<int*>() = 90000;
		*Menu::Global(262145).At(8423).As<int*>() = 120000;
	}
